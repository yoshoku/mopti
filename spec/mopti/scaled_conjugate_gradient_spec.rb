...
RSpec.describe Mopti::ScaledConjugateGradient do
  ...
  let(:optimizer) { described_class.new(fnc: fnc, jcb: jcb, x_init: x, args: [f, k]) }
  ...
  it { expect(res.keys).to match(%i[x n_fev n_jev n_iter fnc jcb]) }
